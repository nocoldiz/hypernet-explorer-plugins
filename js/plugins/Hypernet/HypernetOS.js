    ...
    window.HypernetOS = {
        ...
        Icons: {
            ...
            APPS: {
                ...
                'app-run': 'mimetypes-application-x-executable',
                'app-winver': 'status-dialog-information',
                'app-calc': 'apps-accessories-calculator',
                'app-charmap': 'apps-accessories-character-map',
                'app-clipbrd': 'actions-edit-paste',
                'app-regedit': 'mimetypes-text-x-script',
                'app-msconfig': 'categories-preferences-system',
                'app-cleanmgr': 'actions-edit-clear',
                'app-defrag': 'devices-drive-harddisk',
                'app-timedate': 'mimetypes-x-office-calendar',
                'app-intl': 'apps-preferences-desktop-locale',
                'app-mmsys': 'apps-preferences-desktop-multimedia',
                'app-sysdm': 'devices-computer',
                'app-devmgmt': 'categories-preferences-desktop-peripherals',
                'app-appwiz': 'apps-system-installer',
                'app-schedtasks': 'apps-office-calendar',
                'app-wscui': 'actions-system-lock-screen',
                'app-desk': 'apps-preferences-desktop-wallpaper',
                'app-osk': 'apps-preferences-desktop-keyboard-shortcuts',
                'app-eventvwr': 'actions-document-properties',
                'app-netstat': 'status-network-idle',
                // Internet
