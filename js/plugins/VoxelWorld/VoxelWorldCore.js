...
(() => {
    ...
    // The four frames of a walk sheet's step: left foot, stand, right foot,
    // stand. Out here rather than inside faceCamera, which runs for every
    // billboard in the world every frame - and twice each in split screen - and
